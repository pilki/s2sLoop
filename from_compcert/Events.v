...
Proof.
  ...
  exists (Val.load_result chunk v); exists m1'; dintuition.
  constructor; auto.
  red; auto.
  inv H1. inv H7. inv H5. 
  exploit Mem.load_extends; eauto. intros [v' [A B]]. 
  exists v'; exists m1'; dintuition.
  econstructor; eauto.
  red; auto.
  ...
  exists f; exists (Val.load_result chunk v); exists m1'; dintuition.
  ...
  inv H6; simpl in *.
  exists f; exists v1; exists m1'; dintuition.
  econstructor; eauto.
...
Proof.
  ...
  exists Vundef; exists m1'; dintuition.
  ...
  exists Vundef; exists m'; dintuition.
  constructor; auto.
  red; split; intros.
  ...
  generalize H; intros [P [Q R]].
  exploit P; eauto. intro EQ; rewrite H6 in EQ; inv EQ.
  exists f; exists Vundef; exists m1'; dintuition.
  rewrite Int.add_zero. constructor; auto. 
  ...
  inv H4. 
  exists f; exists Vundef; exists m2'; dintuition.
...
Proof.
  ...
  intros [m2' [C D]].
  exists (Vptr b Int.zero); exists m2'; dintuition.
  econstructor; eauto.
  ...
  instantiate (1 := Vint n). auto. 
  intros [m2' [E G]].
  exists f'; exists (Vptr b' Int.zero); exists m2'; dintuition.
  econstructor; eauto.
  ...
  inv H; inv H0. dintuition congruence. 
Qed.
...
Proof.
  ...
  red; intros. apply Intv.notin_range. simpl. exploit H1; eauto. dintuition. 
  ...
  exists Vundef; exists m2'; dintuition.
  econstructor; eauto.
...
Proof.
  ...
  inv H.
  exists vres; exists m1'; dintuition.
  econstructor; eauto.
  eapply eventval_list_match_lessdef; eauto.
  red; auto.

  inv H0.
  exists f; exists vres; exists m1'; dintuition.
  econstructor; eauto.
  ...
  dintuition. eapply eventval_match_determ_1; eauto.
Qed.
...
Proof.
  ...
  inv H.
  exists (match vargs' with nil => Vundef | v1 :: _ => v1 end); exists m1'; dintuition.
  econstructor; eauto.
  eapply eventval_list_match_lessdef; eauto.
  inv H1; auto.
  red; auto.
  ...
  inv H0.
  exists f; exists (match vargs' with nil => Vundef | v1 :: _ => v1 end); exists m1'; dintuition.
  econstructor; eauto.
  eapply eventval_list_match_inject; eauto.
  inv H2; auto.
  red; auto.
