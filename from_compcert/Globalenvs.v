...
Next Obligation.
  ...
  destruct (b == genv_nextfun0). subst; omega.
...
Next Obligation.
  destruct ge; simpl in *. rewrite ZMap.gsspec in H. 
  destruct (b == genv_nextvar0). subst; omega. 
...
Proof.
  ...
  rewrite IHfl. unfold find_symbol; simpl. apply PTree.gso. dintuition. dintuition.
Qed.
...
Proof.
  ...
  rewrite IHvl. unfold find_symbol; simpl. apply PTree.gso. dintuition. dintuition.
Qed.
...
Proof.
  ...
  unfold block, ZMap.elt, ZEqDec.t; omega.
  ...
  dintuition. unfold find_symbol in H3; simpl in H3. rewrite PTree.gempty in H3. discriminate.
Qed.
...
Proof.
  ...
  intros. exploit genv_symb_range0; eauto. dintuition.
Qed.
...
Proof.
  ...
  eapply IHil; eauto. generalize (init_data_size_pos a). dintuition omega.
  destruct a; simpl in A;
  try (eapply Mem.load_store_other; eauto; dintuition; fail).
  congruence.
  destruct (find_symbol ge i); try congruence. 
  eapply Mem.load_store_other; eauto; dintuition.
Qed.
...
Proof.
  ...
  destruct a; simpl in B; dintuition.
...
Proof.
  ...
  auto.
  repeat rewrite H. destruct a; dintuition. 
Qed.
...
Proof.
  ...
  red. rewrite H1. rewrite <- H3. dintuition.
Qed.
